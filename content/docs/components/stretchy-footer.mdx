...
<ComponentPreview title="Stretchy Footer" stageClassName="min-h-0 overflow-hidden p-0" align="start">
  <StretchyFooterDemo />
</ComponentPreview>
...
<CliCommand command="shadcn@latest add @23rd/stretchy-footer" />

Or install straight from the public GitHub source registry:

<CliCommand
  npm="npx shadcn@latest add radiumcoders/23rd.dev/stretchy-footer"
  pnpm="pnpm dlx shadcn@latest add radiumcoders/23rd.dev/stretchy-footer"
  yarn="yarn dlx shadcn@latest add radiumcoders/23rd.dev/stretchy-footer"
  bun="bunx --bun shadcn@latest add radiumcoders/23rd.dev/stretchy-footer"
/>
...
export function Page() {
  return (
    <StretchyFooter className="h-svh bg-[#0A0A0C]">
      <main className="min-h-[120%] px-8 py-24 text-white">
        {/* …page content… */}
      </main>
      <footer className="px-8 pb-10 text-center text-white/60">
